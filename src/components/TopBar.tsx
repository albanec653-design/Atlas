...
import { Search, Home, Users, MessageCircle, Bell, Menu, Plus, LogOut, Bookmark, Moon, Sun, Compass, ShoppingBag } from 'lucide-react';
...
export function TopBar() {
  ...
  const navItems = [
    ...
    { name: 'marketplace' as const, icon: ShoppingBag, label: 'Marketplace' },
          ...
          <div className="relative" ref={menuRef}>
            ...
            {menuOpen && (
              <div className="absolute right-0 top-full mt-1 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 py-2 w-56 z-50" onMouseLeave={() => setMenuOpen(false)}>
                ...
                <MenuItem icon={ShoppingBag} label="Marketplace" onClick={() => { navigate({ name: 'marketplace' }); setMenuOpen(false); }} />
